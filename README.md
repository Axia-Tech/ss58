...
A list of known [SS58](https://github.com/axia-tech/substrate/wiki/External-Address-Format-(SS58)) account types as an enum.
...
(Typically used by the AXIA, Kusama or Substrate ecosystems.)
